...
bool IA_archPTXDetails::findTableAddrNoTOC(const IA_IAPI* /*blockToCheck*/)
{
	assert(0);
  return tableStartAddress == 0;
}

bool IA_archPTXDetails::parseRelativeTableIdiom()
{
	assert(0);
  return true;
}

namespace detail_archPTX
{
...
bool IA_archPTXDetails::scanForAdjustOrBase(IA_IAPI::allInsns_t::const_iterator /*start*/,
...
bool IA_archPTXDetails::findTableBase(IA_IAPI::allInsns_t::const_iterator /*start*/,
				    IA_IAPI::allInsns_t::const_iterator /*end*/) {
	assert(0);
  return true;
}
...
bool IA_archPTXDetails::parseJumpTable(Block* /*currBlk*/,
...
bool IA_archPTXDetails::parseJumpTable(Dyninst::ParseAPI::Function* currFunc,
