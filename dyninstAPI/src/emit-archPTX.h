...
#ifndef _EMITTER_ARCHPTX_H
#define _EMITTER_ARCHPTX_H
...
class EmitterARCHPTX : public Emitter {

 public:
    virtual ~EmitterARCHPTX() {};
...
class EmitterARCHPTXDyn : public EmitterARCHPTX
{
  public:
  ...
  virtual bool emitTOCJump(block_instance *dest, codeGen &gen) { return emitTOCCommon(dest, false, gen); }
    virtual ~EmitterARCHPTXDyn() {}
 private:
    bool emitTOCCommon(block_instance *dest, bool call, codeGen &gen);

};

class EmitterARCHPTXStat : public EmitterARCHPTX {
  public:
    virtual ~EmitterARCHPTXStat() {}
