...
#define AARCH64_INSN_LENGTH    32
        ...
        class InstructionDecoder_archPTX : public InstructionDecoderImpl {
            friend struct archPTX_insn_entry;
            friend struct archPTX_mask_entry;

        public:
            InstructionDecoder_archPTX(Architecture a);

            virtual ~InstructionDecoder_archPTX();
