...
namespace Dyninst {
  ...
  /*      typedef void (InstructionDecoder_archPTX::*operandFactory)();

        typedef std::vector<operandFactory> operandSpec;
        typedef std::vector<archPTX_insn_entry> archPTX_insn_table;
        typedef std::map<unsigned int, archPTX_mask_entry> archPTX_decoder_table;
        typedef std::map<unsigned int, unsigned int> branchMap;
        typedef uint32_t Bits_t;

        std::vector<std::string> InstructionDecoder_archPTX::condStringMap;
        std::map<unsigned int, MachRegister> InstructionDecoder_archPTX::sysRegMap;
        std::map<entryID, std::string> InstructionDecoder_archPTX::bitfieldInsnAliasMap = boost::assign::map_list_of(
                archPTX_op_bfi_bfm, "bfi")(archPTX_op_bfxil_bfm, "bfxil")(archPTX_op_sbfiz_sbfm, "sbfiz")(
                archPTX_op_sbfx_sbfm, "sbfx")(archPTX_op_ubfiz_ubfm, "ubfiz")(archPTX_op_ubfx_ubfm, "ubfx")(
                archPTX_op_sxtb_sbfm, "sxtb")(archPTX_op_sxth_sbfm, "sxth")(archPTX_op_sxtw_sbfm, "sxtw")(
                archPTX_op_uxtb_ubfm, "uxtb")(archPTX_op_uxth_ubfm, "uxth")(archPTX_op_lsl_ubfm, "lsl")(archPTX_op_lsr_ubfm, "lsr");
	std::map<entryID, std::string> InstructionDecoder_archPTX::condInsnAliasMap = boost::assign::map_list_of(archPTX_op_csinc, "csinc")(archPTX_op_csinv, "csinv")(archPTX_op_csneg, "csneg")
		(archPTX_op_cinc_csinc, "cinc")(archPTX_op_cset_csinc, "cset")
		(archPTX_op_cinv_csinv, "cinv")(archPTX_op_csetm_csinv, "csetm")
		(archPTX_op_cneg_csneg, "cneg");

        struct archPTX_insn_entry {
            archPTX_insn_entry(entryID o, const char *m, operandSpec ops) :
                    op(o), mnemonic(m), operands(ops) {
            }

            archPTX_insn_entry(entryID o, const char *m, operandSpec ops, Bits_t enb, Bits_t mb) :
                    op(o), mnemonic(m), operands(ops), _encodingBits(enb), _maskBits(mb) {
            }

            archPTX_insn_entry() :
                    op(archPTX_op_INVALID), mnemonic("INVALID") {
                operands.reserve(5);
            }

            archPTX_insn_entry(const archPTX_insn_entry &o) :
                    op(o.op), mnemonic(o.mnemonic), operands(o.operands),
                    _encodingBits(o._encodingBits), _maskBits(o._maskBits) {
            }

            const archPTX_insn_entry &operator=(const archPTX_insn_entry &rhs) {
            ...
            static archPTX_insn_table main_insn_table;
        };

        struct archPTX_mask_entry {
            archPTX_mask_entry(unsigned int m, branchMap bm, int tabIndex) :
                    mask(m), nodeBranches(bm), insnTableIndices(std::vector<int>()), insnTableIndex(tabIndex) {
            }

            archPTX_mask_entry(unsigned int m, branchMap bm, std::vector<int> tabIndices) :
            ...
            archPTX_mask_entry(const archPTX_mask_entry &e) :
                    mask(e.mask), nodeBranches(e.nodeBranches), insnTableIndices(e.insnTableIndices),
                    insnTableIndex(e.insnTableIndex) {
            }

            const archPTX_mask_entry &operator=(const archPTX_mask_entry &rhs) {
                mask = rhs.mask;
            ...
            static archPTX_decoder_table main_decoder_table;
        };

        InstructionDecoder_archPTX::InstructionDecoder_archPTX(Architecture a)
            ...
            archPTX_insn_entry::buildInsnTable();
            archPTX_mask_entry::buildDecoderTable();
            InstructionDecoder_archPTX::buildSysRegMap();

            std::string condArray[16] = {"eq", "ne", "cs", "cc", "mi", "pl", "vs", "vc", "hi", "ls", "ge", "lt", "gt",
                                         "le", "al", "nv"};
            InstructionDecoder_archPTX::condStringMap.assign(&condArray[0], &condArray[0] + 16);
            //InstructionDecoder_archPTX::bitfieldInsnAliasMap = boost::assign::map_list_of(archPTX_op_bfi_bfm, "bfi")(archPTX_op_bfxil_bfm, "bfxil")(archPTX_op_sbfiz_sbfm, "sbfiz")(archPTX_op_sbfx_sbfm, "sbfx")(archPTX_op_ubfiz_ubfm, "ubfiz")(archPTX_op_ubfx_ubfm, "ubfx");
        }

        InstructionDecoder_archPTX::~InstructionDecoder_archPTX() {
        }

        void InstructionDecoder_archPTX::decodeOpcode(InstructionDecoder::buffer &b) {
            b.start += 4;
        }

        using namespace std;

        Instruction::Ptr InstructionDecoder_archPTX::decode(InstructionDecoder::buffer &b) {
            if (b.start > b.end)
    ...
    void InstructionDecoder_archPTX::set32Mode()
    {
        // NOTE: is64Bit is set by default.
		is64Bit = false;
    }
    */
      /*  void InstructionDecoder_archPTX::NOTHING() {
        }

        void InstructionDecoder_archPTX::setFPMode() {
            // NOTE: if it is fp, only isFP is set.
            isFPInsn = true;
        }

        //TODO: consistency issue
        void InstructionDecoder_archPTX::setSIMDMode() {
        ...
        void InstructionDecoder_archPTX::OPRtype() {
            _typeField = field<startBit, endBit>(insn);
        }

        void InstructionDecoder_archPTX::processHwFieldInsn(int len, int val) {
        ...
        void InstructionDecoder_archPTX::processShiftFieldShiftedInsn(int len, int val) {
            Result_Type rT;
        ...
        void InstructionDecoder_archPTX::processShiftFieldImmInsn(int len, int val) {
        ...
        Expression::Ptr InstructionDecoder_archPTX::makeOptionExpression(int len, int val) {
            MachRegister reg;
            int encoding = field<16, 20>(insn);

            reg = ((optionField & 0x3) == 0x3) ? ((encoding == 31) ? archPTX::zr : archPTX::x0) : ((encoding == 31)
                                                                                                   ? archPTX::wzr
                                                                                                   : archPTX::w0);
            if (encoding != 31)
        ...
        void InstructionDecoder_archPTX::processOptionFieldLSRegOffsetInsn() {
        ...
        void InstructionDecoder_archPTX::processSystemInsn() {
            ...
            else                   //mrs (register), msr
            {
                ...
                if (InstructionDecoder_archPTX::sysRegMap.count(systemRegEncoding) <= 0)
                    assert(!"tried to access system register not accessible in EL0");

                MachRegister reg;
                if ((op0Field & 0x3) == 0x3 && (crnField & 0x3) == 0x3 && (crnField & 0x8) == 0x8)
                    //reg = archPTX::IMPLEMENTATION_DEFINED_SYSREG;
                else
                    reg = InstructionDecoder_archPTX::sysRegMap[systemRegEncoding];
        ...
        Result_Type InstructionDecoder_archPTX::makeSizeType(unsigned int) {
...
#define fn(x) (&InstructionDecoder_archPTX::x)
#define    COMMA    ,

        MachRegister InstructionDecoder_archPTX::makeAarch64RegID(MachRegister base, unsigned int encoding) {
            return MachRegister(base.val() + encoding);
        }

        template<unsigned int endBit, unsigned int startBit>
        void InstructionDecoder_archPTX::OPRsize() {
            size = field<startBit, endBit>(insn);
        }

        Expression::Ptr InstructionDecoder_archPTX::makeRdExpr() {
            ...
            if (isSIMDInsn) {
                if (IS_INSN_SIMD_ACROSS(insn)) {
                    ...
                    if (field<14, 14>(insn) == 0x1) {
                        ...
                        switch (size) {
                            case 0x0:
                                reg = (opcode == 0x03) ? archPTX::h0 : archPTX::b0;
                                break;
                            case 0x1:
                                reg = (opcode == 0x03) ? archPTX::s0 : archPTX::h0;
                                break;
                            case 0x2:
                                reg = (opcode == 0x03) ? archPTX::d0 : archPTX::s0;
                                break;
                            default:
                                isValid = false;
                        }
                    ...
                    if (op == 0x1)
                        ...
                        switch (imm4) {
                            case 0x5:
                            case 0x7:
                                reg = _Q == 0x1 ? archPTX::x0 : archPTX::w0;
                                break;
                            default:
                                reg = _Q == 0x1 ? archPTX::q0 : archPTX::d0;
                                break;
                        }
                    }
                }
                    ...
                    if (_szField == -1) {
                        ...
                        switch (_szField) {
                            ...
                            case 0x1: {
                                ...
                                reg = (op == archPTX_op_fcvtxn_advsimd) ? archPTX::s0 : archPTX::d0;
                            }
                                break;
                            default:
                                isValid = false;
                    ...
                    if (op == archPTX_op_addhn_advsimd || op == archPTX_op_subhn_advsimd ||
                        op == archPTX_op_raddhn_advsimd || op == archPTX_op_rsubhn_advsimd)
                        reg = _Q == 0x1 ? archPTX::hq0 : archPTX::d0;
                    else
                        reg = archPTX::q0;
                }
                ...
                if (IS_INSN_FP_DATAPROC_ONESRC(insn)) {
                    ...
                    reg = isSinglePrec() ? archPTX::s0 : archPTX::d0;
                ...
                if (encoding == 31)
                    reg = ((IS_INSN_ADDSUB_IMM(insn) || IS_INSN_ADDSUB_EXT(insn) || IS_INSN_LOGICAL_IMM(insn)) &&
                           !isPstateWritten) ? (is64Bit ? archPTX::sp : archPTX::wsp) : (is64Bit ? archPTX::zr
                                                                                                 : archPTX::wzr);
                else
                    reg = is64Bit ? archPTX::x0 : archPTX::w0;
        ...
        void InstructionDecoder_archPTX::OPRRd() {
        ...
        Expression::Ptr InstructionDecoder_archPTX::makeRnExpr() {
            ...
            if (isSIMDInsn && !IS_INSN_LDST(insn)) {
                if (IS_INSN_SIMD_COPY(insn)) {
                    ...
                    //ins (element)
                    if (op == 0x1) {
                        reg = (imm4 & 0x8) ? archPTX::q0 : archPTX::d0;
                    }
                    else {
                        switch (imm4) {
                            ...
                            case 0x5:
                            case 0x7:
                                reg = (imm5 & 0x10) ? archPTX::q0 : archPTX::d0;
                                break;
                                //dup (general), ins (general)
                            case 0x1:
                            case 0x3:
                                if (imm5 & 0x1 || imm5 & 0x2 || imm5 & 0x4) {
                                    reg = encoding == 31 ? archPTX::wzr : archPTX::w0;
                                }
                                else {
                                    reg = encoding == 31 ? archPTX::zr : archPTX::x0;
                                }
                                break;
                            default:
                                isValid = false;
                    ...
                    switch (switchbit) {
                        case 0x1:
                            reg = isRnVa ? archPTX::h0 : archPTX::b0;
                            break;
                        case 0x2:
                            reg = isRnVa ? archPTX::s0 : archPTX::h0;
                            break;
                        case 0x3:
                            reg = isRnVa ? archPTX::d0 : archPTX::s0;
                            break;
                        case 0x4:
                            isRnVa ? (isValid = false) : (reg = archPTX::d0);
                            break;
                        default:
                            isValid = false;
                    }
                    ...
                    if (_szField == -1) {
                        ...
                        switch (_szField) {
                            case 0x0:
                                isRnVa ? (isValid = false) : (reg = archPTX::s0);
                                break;
                            case 0x1:
                                reg = archPTX::d0;
                                break;
                    ...
                    reg = _Q == 1 ? archPTX::q0 : archPTX::d0;
                    ...
                    if (op == archPTX_op_saddw_advsimd || op == archPTX_op_ssubw_advsimd ||
                        op == archPTX_op_addhn_advsimd || op == archPTX_op_subhn_advsimd ||
                        op == archPTX_op_uaddw_advsimd || op == archPTX_op_usubw_advsimd ||
                        op == archPTX_op_raddhn_advsimd || op == archPTX_op_rsubhn_advsimd)
                        reg = archPTX::q0;
                    else
                        reg = _Q == 0x1 ? archPTX::hq0 : archPTX::d0;
                ...
                if (!(reg == archPTX::wzr || reg == archPTX::zr))
                    reg = makeAarch64RegID(reg, encoding);
            }
            else if (isFPInsn && !((IS_INSN_FP_CONV_FIX(insn) || (IS_INSN_FP_CONV_INT(insn))) && IS_SOURCE_GP(insn))) {
                switch (_typeField) {
                ...
                reg = encoding == 31 ? archPTX::sp : archPTX::x0;
                ...
                if (encoding == 31)
                    reg = (IS_INSN_ADDSUB_IMM(insn) || IS_INSN_ADDSUB_EXT(insn)) ? (is64Bit ? archPTX::sp
                                                                                            : archPTX::wsp) : (is64Bit
                                                                                                               ? archPTX::zr
                                                                                                               : archPTX::wzr);
                else
        ...
        Expression::Ptr InstructionDecoder_archPTX::makePCExpr() {
            MachRegister baseReg = archPTX::pc;

            return makeRegisterExpression(makeAarch64RegID(baseReg, 0));
        }

        Expression::Ptr InstructionDecoder_archPTX::makePstateExpr() {
            MachRegister baseReg = archPTX::pstate;

            return makeRegisterExpression(makeAarch64RegID(baseReg, 0));
        }


        void InstructionDecoder_archPTX::getMemRefIndexLiteral_OffsetLen(int &immVal, int &immLen) {
        ...
        void InstructionDecoder_archPTX::getMemRefIndexLiteral_RT(Result_Type &rt) {
...
// ****************************************
        Expression::Ptr InstructionDecoder_archPTX::makeMemRefIndexLiteral() {
            int immVal, immLen;
...
// shared by ld/st uimm, post, pre, reg
        void InstructionDecoder_archPTX::getMemRefIndex_RT(Result_Type &rt) {
        ...
        void InstructionDecoder_archPTX::getMemRefPair_RT(Result_Type &rt) {
        ...
        void InstructionDecoder_archPTX::getMemRefIndex_SizeSizelen(unsigned int &size, unsigned int &sizeLen) {
        ...
        void InstructionDecoder_archPTX::getMemRefIndexPrePost_ImmImmlen(unsigned int &immVal, unsigned int &immLen) {
            immVal = field<12, 20>(insn);
            immLen = 20 - 12 + 1;
            return;
        }

        void InstructionDecoder_archPTX::getMemRefPair_ImmImmlen(unsigned int &immVal, unsigned int &immLen) {
...
// load from [PC + offset] to Xt
// ****************************************
        Expression::Ptr InstructionDecoder_archPTX::makeMemRefIndexUImm() {
        ...
        Expression::Ptr InstructionDecoder_archPTX::makeMemRefIndex_offset9() {
...
// LSL(sign_ex(imm7 , 64), scale)
        Expression::Ptr InstructionDecoder_archPTX::makeMemRefPair_offset7() {
            /*
    ...
    */
        ...
        Expression::Ptr InstructionDecoder_archPTX::makeMemRefIndex_addOffset9() {
            Expression::Ptr offset = makeMemRefIndex_offset9();
            return makeAddExpression(makeRnExpr(), offset, u64);
        }

        Expression::Ptr InstructionDecoder_archPTX::makeMemRefPair_addOffset7() {
            Expression::Ptr offset = makeMemRefPair_offset7();
            return makeAddExpression(makeRnExpr(), offset, u64);
        }

        Expression::Ptr InstructionDecoder_archPTX::makeMemRefIndexPre() {
            Result_Type rt;
            getMemRefIndex_RT(rt);
            return makeDereferenceExpression(makeMemRefIndex_addOffset9(), rt);
        }

        Expression::Ptr InstructionDecoder_archPTX::makeMemRefIndexPost() {
            Result_Type rt;
            getMemRefIndex_RT(rt);
            return makeDereferenceExpression(makeRnExpr(), rt);
        }

        Expression::Ptr InstructionDecoder_archPTX::makeMemRefPairPre() {
            Result_Type rt;
            getMemRefPair_RT(rt);
            return makeDereferenceExpression(makeMemRefPair_addOffset7(), rt);
        }

        Expression::Ptr InstructionDecoder_archPTX::makeMemRefPairPost() {
            Result_Type rt;
            getMemRefPair_RT(rt);
            return makeDereferenceExpression(makeRnExpr(), rt);
        }

        void InstructionDecoder_archPTX::getMemRefEx_RT(Result_Type &rt) {
        ...
        Expression::Ptr InstructionDecoder_archPTX::makeMemRefEx() {
            Result_Type rt;
            getMemRefEx_RT(rt);
            return makeDereferenceExpression(makeRnExpr(), rt);
        }

        void InstructionDecoder_archPTX::OPRQ() {
            _Q = field<30, 30>(insn);
        }

        void InstructionDecoder_archPTX::OPRL() {
            _L = field<30, 30>(insn);
        }

        unsigned int InstructionDecoder_archPTX::getMemRefSIMD_MULT_T() {
            unsigned int Q = field<30, 30>(insn);
            return Q ? 128 : 64;
        }

        void InstructionDecoder_archPTX::getMemRefSIMD_MULT_RT(Result_Type &rt) {
        ...
        unsigned int InstructionDecoder_archPTX::getSIMD_SING_selem() {
            return (((field<13, 13>(insn) << 1) & 0x2) | (field<21, 21>(insn) & 0x1)) + 0x1;
        }

        void InstructionDecoder_archPTX::getMemRefSIMD_SING_RT(Result_Type &rt) {
        ...
        unsigned int InstructionDecoder_archPTX::getMemRefSIMD_SING_T() {
        ...
        Expression::Ptr InstructionDecoder_archPTX::makeMemRefSIMD_MULT() {
            Result_Type rt;
            getMemRefSIMD_MULT_RT(rt);
            return makeDereferenceExpression(makeRnExpr(), rt);
        }

        Expression::Ptr InstructionDecoder_archPTX::makeMemRefSIMD_SING() {
            Result_Type rt;
            getMemRefSIMD_SING_RT(rt);
            return makeDereferenceExpression(makeRnExpr(), rt);
        }

        void InstructionDecoder_archPTX::getMemRefExPair_RT(Result_Type &rt) {
        ...
        Expression::Ptr InstructionDecoder_archPTX::makeMemRefExPair() {
            Result_Type rt;
...
/*
Expression::Ptr InstructionDecoder_archPTX::makeMemRefExPair16B(){
    return makeDereferenceExpression(makeRnExpr(), dbl128);
}
*/

/*
Expression::Ptr InstructionDecoder_archPTX::makeMemRefExPair2(){
...
*/
    ...
    /*    Expression::Ptr InstructionDecoder_archPTX::makeMemRefReg_Rm() {
            unsigned int option = field<13, 15>(insn);
            if ((option & 2) != 2)
                isValid = false;
            MachRegister baseReg = ((option & 0x3) == 0x2) ? archPTX::w0 : archPTX::x0;
            unsigned int encoding = field<16, 20>(insn);

            if (encoding == 31)//zero register
                return makeRegisterExpression(makeAarch64RegID(archPTX::zr, 0));
            else
                return makeRegisterExpression(makeAarch64RegID(baseReg, encoding));
        }

        Expression::Ptr InstructionDecoder_archPTX::makeMemRefReg_amount() {
            unsigned int S = field<12, 12>(insn);
        ...
        Expression::Ptr InstructionDecoder_archPTX::makeMemRefReg_ext() {
            int immLen = 2;
...
//      [Rm] [amount]
**********************/
      /*  Expression::Ptr InstructionDecoder_archPTX::makeMemRefReg() {
        ...
        void InstructionDecoder_archPTX::LIndex() {
            // never be called
        ...
        void InstructionDecoder_archPTX::STIndex() {
            if (IS_INSN_LD_LITERAL(insn))
...
// This function is for non-writeback
        void InstructionDecoder_archPTX::OPRRn() {
	    if(skipRn)
		return;
        ...
        void InstructionDecoder_archPTX::OPRRnL() {
            LIndex();
        }

        void InstructionDecoder_archPTX::OPRRnS() {
            STIndex();
        }

        void InstructionDecoder_archPTX::OPRRnU() {
            assert(0);
    ...
    */
     /*   }
        ...
        void InstructionDecoder_archPTX::OPRRnLU() {
            if (IS_INSN_LDST_PRE(insn) || IS_INSN_LDST_POST(insn) || IS_INSN_LDST_PAIR_PRE(insn) ||
                IS_INSN_LDST_PAIR_POST(insn))
                LIndex();
        }

        void InstructionDecoder_archPTX::OPRRnSU() {
            if (IS_INSN_LDST_PRE(insn) || IS_INSN_LDST_POST(insn) || IS_INSN_LDST_PAIR_PRE(insn) ||
                IS_INSN_LDST_PAIR_POST(insn))
                STIndex();
        }

        unsigned int InstructionDecoder_archPTX::get_SIMD_MULT_POST_imm() {
            unsigned int rpt = 0, selem = 0;
            getSIMD_MULT_RptSelem(rpt, selem);
        ...
        unsigned int InstructionDecoder_archPTX::get_SIMD_SING_POST_imm() {
            return (getMemRefSIMD_SING_T() >> 3) * getSIMD_SING_selem();
        }

        Expression::Ptr InstructionDecoder_archPTX::makeRmExpr() {
            int encoding = field<16, 20>(insn);
            MachRegister reg;
            ...
            if (isSIMDInsn) {
                if (IS_INSN_LDST_SIMD_MULT_POST(insn)) {
                    ...
                    reg = field<11, 11>(insn) == 0x1 ? archPTX::q0 : archPTX::d0;
                ...
                reg = is64Bit ? ((encoding == 31) ? archPTX::zr : archPTX::x0) : ((encoding == 31) ? archPTX::wzr
                                                                                                   : archPTX::w0);
                if (encoding != 31)
                    reg = makeAarch64RegID(reg, encoding);
            }
        ...
        void InstructionDecoder_archPTX::OPRRm() {
	    if(skipRm)
		return;
        ...
        void InstructionDecoder_archPTX::OPRsf() {
            if (field<31, 31>(insn) == 0)
                is64Bit = false;
        }

        template<unsigned int endBit, unsigned int startBit>
        void InstructionDecoder_archPTX::OPRoption() {
            hasOption = true;
            optionField = field<startBit, endBit>(insn);
        }

        void InstructionDecoder_archPTX::OPRshift() {
            hasShift = true;
            shiftField = field<22, 23>(insn);
        }

        void InstructionDecoder_archPTX::OPRhw() {
            hasHw = true;
            hwField = field<21, 22>(insn);
        }

        template<unsigned int endBit, unsigned int startBit>
        void InstructionDecoder_archPTX::OPRN() {
            hasN = true;
...
// except for ld/st{s, h, w} subclass
        void InstructionDecoder_archPTX::setRegWidth() {
        ...
        MachRegister InstructionDecoder_archPTX::getLoadStoreSimdRegister(int encoding) {
            MachRegister reg;

            if (size != -1) {
                switch (size) {
                    case 0x0:
                        reg = (field<23, 23>(insn) == 0x1) ? archPTX::q0 : archPTX::b0;
                        break;
                    case 0x1:
                        reg = archPTX::h0;
                        break;
        ...
        Expression::Ptr InstructionDecoder_archPTX::makeRtExpr() {
            int encoding = field<0, 4>(insn);
            MachRegister reg;

            if (isFPInsn) {
                reg = makeAarch64RegID(isSinglePrec() ? archPTX::s0 : archPTX::d0, encoding);
            }
            else if (isSIMDInsn) {
        ...
        void InstructionDecoder_archPTX::getSIMD_MULT_RptSelem(unsigned int &rpt, unsigned int &selem) {
        ...
        void InstructionDecoder_archPTX::OPRRt() {
            int encoding = field<0, 4>(insn);
            entryID op = insn_in_progress->getOperation().operationID;

            if (IS_INSN_BRANCHING(insn)) {
                if (encoding == 31)
                    insn_in_progress->appendOperand(makeRegisterExpression(is64Bit ? archPTX::zr : archPTX::wzr), true,
                                                    false);
                else
                    insn_in_progress->appendOperand(
                            makeRegisterExpression(makeAarch64RegID(is64Bit ? archPTX::x0 : archPTX::w0, encoding)),
                            true, false);
            }
            else if (op == archPTX_op_prfm_imm || op == archPTX_op_prfm_lit || op == archPTX_op_prfm_reg) {
        ...
        void InstructionDecoder_archPTX::OPRRtS() {
            int encoding = field<0, 4>(insn);
        ...
        Expression::Ptr InstructionDecoder_archPTX::makeRt2Expr() {
            MachRegister baseReg;
            int encoding = field<10, 14>(insn);

            if (isFPInsn) {
                baseReg = makeAarch64RegID(isSinglePrec() ? archPTX::s0 : archPTX::d0, encoding);
            }
            else if (isSIMDInsn) {
                baseReg = getLoadStoreSimdRegister(encoding);
            }
            else {
                baseReg = makeAarch64RegID(is64Bit ? archPTX::x0 : archPTX::w0, encoding);
            }

            return makeRegisterExpression(baseReg);
        }

        void InstructionDecoder_archPTX::OPRRt2() {
            assert(0);
        }

        void InstructionDecoder_archPTX::OPRRt2L() {
            insn_in_progress->appendOperand(makeRt2Expr(), false, true);
        }

        void InstructionDecoder_archPTX::OPRRt2S() {
            insn_in_progress->appendOperand(makeRt2Expr(), true, false);
        }

        template<unsigned int endBit, unsigned int startBit>
        void InstructionDecoder_archPTX::OPRcond() {
        ...
        void InstructionDecoder_archPTX::OPRnzcv() {
        ...
        void InstructionDecoder_archPTX::OPRop1() {
            op1Field = field<16, 18>(insn);
        }

        void InstructionDecoder_archPTX::OPRop2() {
            op2Field = field<5, 7>(insn);
        }

        void InstructionDecoder_archPTX::OPRCRm() {
            crmField = field<8, 11>(insn);
        }

        void InstructionDecoder_archPTX::OPRCRn() {
        }

        template<unsigned int endBit, unsigned int startBit>
        void InstructionDecoder_archPTX::OPRS() {
            sField = field<startBit, endBit>(insn);
        }

        void InstructionDecoder_archPTX::OPRscale() {
        ...
        Expression::Ptr InstructionDecoder_archPTX::makeRaExpr() {
            int encoding = field<10, 14>(insn);
            MachRegister reg;
            ...
            if (isFPInsn) {
                ...
                reg = is64Bit ? ((encoding == 31) ? archPTX::sp : archPTX::x0) : ((encoding == 31) ? archPTX::wsp
                                                                                                   : archPTX::w0);
                if (encoding != 31)
                    reg = makeAarch64RegID(reg, encoding);
            }
        ...
        void InstructionDecoder_archPTX::OPRRa() {
            insn_in_progress->appendOperand(makeRaExpr(), true, false);

            oprRotateAmt++;
        }

        void InstructionDecoder_archPTX::OPRo0() {

        }

        void InstructionDecoder_archPTX::OPRb5() {
            OPRsf();
            hasb5 = true;
        }

        void InstructionDecoder_archPTX::OPRb40() {

        }

        Expression::Ptr InstructionDecoder_archPTX::makeb40Expr() {
        ...
        template<unsigned int endBit, unsigned int startBit>
        void InstructionDecoder_archPTX::OPRsz() {
            _szField = field<startBit, endBit>(insn);
        }

        bool InstructionDecoder_archPTX::isSinglePrec() {
        ...
        Expression::Ptr InstructionDecoder_archPTX::makeRsExpr() {
            MachRegister baseReg = isFPInsn ?
                                   (isSinglePrec() ? archPTX::s0 : archPTX::d0) :
                                   (is64Bit ? archPTX::x0 : archPTX::w0);
        ...
        void InstructionDecoder_archPTX::OPRRs() {
            insn_in_progress->appendOperand(makeRsExpr(), false, true);
        }

        void InstructionDecoder_archPTX::makeBranchTarget(bool branchIsCall, bool bIsConditional, int immVal,
                                                          int immLen) {
        ...
        Expression::Ptr InstructionDecoder_archPTX::makeFallThroughExpr() {
        ...
        Expression::Ptr InstructionDecoder_archPTX::fpExpand(int val) {
            int N, E, F;
        ...
        template<typename T>
        Expression::Ptr InstructionDecoder_archPTX::makeLogicalImm(int immr, int imms, int immsLen, Result_Type rT) {
        ...
        bool InstructionDecoder_archPTX::fix_bitfieldinsn_alias(int immr, int imms) {
            entryID modifiedID = insn_in_progress->getOperation().operationID;
            bool do_further_processing = true;

            switch (field<27, 30>(insn)) {
                case 0x6:
                    modifiedID = (imms < immr) ? archPTX_op_bfi_bfm : archPTX_op_bfxil_bfm;
                    break;
                case 0x2:
                    if (immr == 0 && (imms == 7 || imms == 15 || imms == 31)) {
                        ...
                        switch (imms) {
                            case 7:
                                modifiedID = archPTX_op_sxtb_sbfm;
                                break;
                            case 15:
                                modifiedID = archPTX_op_sxth_sbfm;
                                break;
                            case 31:
                                modifiedID = archPTX_op_sxtw_sbfm;
                                break;
                        }
                    }
                    else
                        modifiedID = (imms < immr) ? archPTX_op_sbfiz_sbfm : archPTX_op_sbfx_sbfm;
                    break;
                case 0xA:
                    if (immr == 0 && (imms == 7 || imms == 15)) {
                        ...
                        switch (imms) {
                            case 7:
                                modifiedID = archPTX_op_uxtb_ubfm;
                                break;
                            case 15:
                                modifiedID = archPTX_op_uxth_ubfm;
                                break;
                        }
                    }
		    else if((imms != 31 || imms != 63) && (imms + 1) == immr)
			modifiedID = archPTX_op_lsl_ubfm;
		    else if((imms & 0x1F) == 0x1F)
			modifiedID = archPTX_op_lsr_ubfm;
                    else
                        modifiedID = (imms < immr) ? archPTX_op_ubfiz_ubfm : archPTX_op_ubfx_ubfm;
                    break;
                default:
                    isValid = false;
            }
        ...
        void InstructionDecoder_archPTX::fix_condinsn_alias_and_cond(int &cond) {
            entryID modifiedID = insn_in_progress->getOperation().operationID;
            if (modifiedID == archPTX_op_csel)
                return;

            int Rm = field<16, 20>(insn), Rn = field<5, 9>(insn);

            if (Rm == Rn && (cond & 0xE) != 0xE && modifiedID == archPTX_op_csneg) {
                modifiedID = archPTX_op_cneg_csneg;
		skipRm = true;
            } else if (Rm != 31 && Rn != 31 && (cond & 0xE) != 0xE && Rm == Rn) {
                switch (modifiedID) {
                    case archPTX_op_csinc:
                        modifiedID = archPTX_op_cinc_csinc;
                        break;
                    case archPTX_op_csinv:
                        modifiedID = archPTX_op_cinv_csinv;
                        break;
                    default:
                        isValid = false;
                }
		...
		skipRm = true;
                ...
                switch (modifiedID) {
                    case archPTX_op_csinc:
                        modifiedID = archPTX_op_cset_csinc;
                        break;
                    case archPTX_op_csinv:
                        modifiedID = archPTX_op_csetm_csinv;
                        break;
                    default:
                        isValid = false;
                }
        ...
        template<unsigned int endBit, unsigned int startBit>
        void InstructionDecoder_archPTX::OPRimm() {
			...
			entryID curID;
			    ...
			    if(curID == archPTX_op_lsl_ubfm || curID == archPTX_op_lsr_ubfm)
				isLsrLsl = true;
                            
			    if (curID != archPTX_op_lsr_ubfm && immVal < immr) {
            ...
            insn_in_progress->appendOperand(imm, true, false);
                    ...
                    if (startBit == 19 && endBit == 22) {
                        ...
                        if (insnID == archPTX_op_shl_advsimd || insnID == archPTX_op_sqshl_advsimd_imm ||
                            insnID == archPTX_op_sshll_advsimd ||
                            insnID == archPTX_op_sli_advsimd || insnID == archPTX_op_sqshlu_advsimd ||
                            insnID == archPTX_op_uqshl_advsimd_imm || insnID == archPTX_op_ushll_advsimd)
                            isRightShift = -1;
        ...
        void InstructionDecoder_archPTX::reorderOperands() {
            if (oprRotateAmt) {
        ...
        void InstructionDecoder_archPTX::processAlphabetImm() {
            if (op == 1 && cmode == 0xE) {
                uint64_t imm = 0;
...
#include "archPTX_opcode_tables.C"

        void InstructionDecoder_archPTX::doDelayedDecode(const Instruction *insn_to_complete) {
        ...
        bool InstructionDecoder_archPTX::decodeOperands(const Instruction * insn_to_complete) {
            int insn_table_index = findInsnTableIndex(0);
            archPTX_insn_entry *insn_table_entry = &archPTX_insn_entry::main_insn_table[insn_table_index];
        ...
        int InstructionDecoder_archPTX::findInsnTableIndex(unsigned int decoder_table_index) {
            archPTX_mask_entry *cur_entry = &archPTX_mask_entry::main_decoder_table[decoder_table_index];
        ...
        void InstructionDecoder_archPTX::setFlags() {
            isPstateWritten = true;
        }

        void InstructionDecoder_archPTX::mainDecode() {
            int insn_table_index = findInsnTableIndex(0);
            archPTX_insn_entry *insn_table_entry = &archPTX_insn_entry::main_insn_table[insn_table_index];
            ...
            insn_in_progress->arch_decoded_from = Arch_archPTX;
            return;
        }
    */
};
